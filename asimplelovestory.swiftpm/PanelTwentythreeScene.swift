...
class PanelTwentythreeScene:SKScene {
    
    var panelsLogic: PanelsLogic = PanelsLogic.shared
    
    var wrapper:SKNode = SKNode()
    var panel:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta23")
    var balloon:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta23balloon")
    var balloonFull:SKTexture = SKTexture(imageNamed: "vignetta23balloonfull")
    ...
    func addBallon(){
        ...
        self.balloon.position = CGPoint(x: 200, y: CGFloat(self.panel.size.height-100))
    ...
    func exitAnimation() {
        ...
        let removeAction = SKAction.run {
            ...
            self.panelsLogic.currentPanel = 24
