...
class PanelFourScene:SKScene {
    
    var panelsLogic: PanelsLogic = PanelsLogic.shared
    
    var wrapper:SKNode = SKNode()
    var panel:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta4-1")
    var frameOne:SKTexture = SKTexture(imageNamed: "vignetta4-2")
    var frameTwo:SKTexture = SKTexture(imageNamed: "vignetta4-3")
    var frameThree:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta4-4")
    ...
    func animation() -> SKAction {
        ...
        let sequence = SKAction.sequence([waitAction, changeTextureOne, waitAction, changeTextureTwo, waitAction, waitAction, nextButtonAppearAction])
    ...
    func exitAnimation() {
        ...
        let removeAction = SKAction.run {
            ...
            self.panelsLogic.currentPanel = 5
