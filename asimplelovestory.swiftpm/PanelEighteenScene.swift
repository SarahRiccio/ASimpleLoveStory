...
class PanelEighteenScene:SKScene {
    
    var panelsLogic: PanelsLogic = PanelsLogic.shared
    
    var wrapper:SKNode = SKNode()
    var panel:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta18")
    var balloon:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta18balloon")
    var frameOne:SKTexture = SKTexture(imageNamed: "vignetta18balloonfull")
    var balloonFull:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta18balloonfull")
    ...
    func addBalloon() {
        ...
        self.balloon.position.x = 50
        self.balloon.position.y = CGFloat(self.panel.size.height/2+50)
    ...
    func exitAnimation() {
        ...
        let removeAction = SKAction.run {
            ...
            self.panelsLogic.currentPanel = 19
