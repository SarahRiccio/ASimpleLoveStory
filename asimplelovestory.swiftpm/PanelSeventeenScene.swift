...
class PanelSeventeenScene:SKScene {
    
    var panelsLogic: PanelsLogic = PanelsLogic.shared
    
    var wrapper:SKNode = SKNode()
    var panel:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta17")
    var balloon:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta17balloon")
    var frameOne:SKTexture = SKTexture(imageNamed: "vignetta17balloonfull")
    ...
    func exitAnimation() {
        ...
        let removeAction = SKAction.run {
            ...
            self.panelsLogic.currentPanel = 18
