...
class PanelThirteenScene:SKScene {
    
    var panelsLogic: PanelsLogic = PanelsLogic.shared
    
    var wrapper:SKNode = SKNode()
    var panel:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta13")
    ...
    func addSleep() {
        ...
        self.sleep.alpha = 0
        self.sleep.position.y = CGFloat(self.panel.size.height/2)
        self.sleep.position.x = -100
    ...
    func exitAnimation() {
        ...
        let removeAction = SKAction.run {
            ...
            self.panelsLogic.currentPanel = 14
