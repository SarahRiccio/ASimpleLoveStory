...
class PanelTwentyScene:SKScene {
    
    var panelsLogic: PanelsLogic = PanelsLogic.shared
    
    var wrapper:SKNode = SKNode()
    var panel:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta20")
    var balloon:SKSpriteNode = SKSpriteNode(imageNamed: "vignetta20balloon")
    var balloonFull:SKTexture = SKTexture(imageNamed: "vignetta20balloonfull")
    ...
    func exitAnimation() {
        ...
        let removeAction = SKAction.run {
            ...
            self.panelsLogic.currentPanel = 21
