...
class PanelTwentyfourScene:SKScene {
    
    var panelsLogic: PanelsLogic = PanelsLogic.shared
    
    var wrapper:SKNode = SKNode()
    var panel:SKSpriteNode = SKSpriteNode()
    var frameOne:SKTexture = SKTexture(imageNamed: "vignetta24-1")
    var frameTwo:SKTexture = SKTexture(imageNamed: "vignetta24-2")
    ...
    override func sceneDidLoad() {
        ...
        self.panel = SKSpriteNode(imageNamed: "vignetta24-1")
    ...
    func animation() -> SKAction {
        ...
        let repeatAction = SKAction.repeat(SKAction.sequence([changeTextureTwo, waitAction, changeTextureOne, waitAction]), count: 2)
        
        let sequence = SKAction.sequence([longWaitAction, repeatAction, nextButtonAppearAction])
    ...
    func exitAnimation() {
        ...
        let removeAction = SKAction.run {
            ...
            self.panelsLogic.currentPanel = 25
